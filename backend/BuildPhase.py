...
def build_tower_phase(game_state: GameState, ai_action_r: AIAction, ai_action_b : AIAction) -> None:
    ...
    if ai_action_r.buy_tower_action and game_state.tile_grid[x][y] == "r" and not game_state.entity_grid[x][y] is None:
